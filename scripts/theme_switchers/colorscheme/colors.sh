...
# Adjusted to keep themes inside the repository
COLORSCHEMES_DIR="$HOME/.dotfiles/colorschemes"
INDEX_LOOP=0

# Adjusted to be consistent with the user's config structure
THEME_USED_PATH="${HOME}/.config/zsh/theme_data/colorscheme"
...
\e[3$(( $RANDOM * 6 / 32767 + 1 ))m _       ___ | | ___   ____ ___  ____| |__  _ ____ ____  _____
\e[9$(( $RANDOM * 6 / 32767 + 1 ))m| |     / _ \| |/ _ \ / ___)___)/ ___)  _ \| ___ |    \| ___ |
\e[3$(( $RANDOM * 6 / 32767 + 1 ))m| |____| |_| | | |_| | |  |___ ( (___| | | | ____| | | | ____|
\e[9$(( $RANDOM * 6 / 32767 + 1 ))m \______)___/ \_)___/|_|  (___/ \____)_| |_|_ ____)_|_|_|_____)
${COLOR_BASED}\n"
}
